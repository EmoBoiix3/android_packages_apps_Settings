 ...
 */
public class SettingsDevice extends PreferenceActivity
    ...
    public void onBuildHeaders(List<Header> headers) {
        loadHeadersFromResource(R.xml.settings_device_headers, headers);
    ...
    private void updateHeaderList(List<Header> target) {
        ...
        while (i < target.size()) {
            ...
            if (id == R.id.homescreen_settings) {
    ...
    public boolean shouldUpRecreateTask(Intent targetIntent) {
        return super.shouldUpRecreateTask(new Intent(this, SettingsDevice.class));
    }
     ...
     */
    public static class BluetoothSettingsActivity extends SettingsDevice { /* empty */ }
    public static class WirelessSettingsActivity extends SettingsDevice { /* empty */ }
    public static class TetherSettingsActivity extends SettingsDevice { /* empty */ }
    public static class VpnSettingsActivity extends SettingsDevice { /* empty */ }
    public static class DateTimeSettingsActivity extends SettingsDevice { /* empty */ }
    public static class StorageSettingsActivity extends SettingsDevice { /* empty */ }
    public static class WifiSettingsActivity extends SettingsDevice { /* empty */ }
    public static class WifiP2pSettingsActivity extends SettingsDevice { /* empty */ }
    public static class InputMethodAndLanguageSettingsActivity extends SettingsDevice { /* empty */ }
    public static class KeyboardLayoutPickerActivity extends SettingsDevice { /* empty */ }
    public static class InputMethodAndSubtypeEnablerActivity extends SettingsDevice { /* empty */ }
    public static class SpellCheckersSettingsActivity extends SettingsDevice { /* empty */ }
    public static class LocalePickerActivity extends SettingsDevice { /* empty */ }
    public static class UserDictionarySettingsActivity extends SettingsDevice { /* empty */ }
    public static class SoundSettingsActivity extends SettingsDevice { /* empty */ }
    public static class DisplaySettingsActivity extends SettingsDevice { /* empty */ }
    public static class DeviceInfoSettingsActivity extends SettingsDevice { /* empty */ }
    public static class ApplicationSettingsActivity extends SettingsDevice { /* empty */ }
    public static class ManageApplicationsActivity extends SettingsDevice { /* empty */ }
    public static class AppOpsSummaryActivity extends SettingsDevice { /* empty */ }
    public static class StorageUseActivity extends SettingsDevice { /* empty */ }
    public static class DevelopmentSettingsActivity extends SettingsDevice { /* empty */ }
    public static class AccessibilitySettingsActivity extends SettingsDevice { /* empty */ }
    public static class SecuritySettingsActivity extends SettingsDevice { /* empty */ }
    public static class LocationSettingsActivity extends SettingsDevice { /* empty */ }
    public static class PrivacySettingsActivity extends SettingsDevice { /* empty */ }
    public static class RunningServicesActivity extends SettingsDevice { /* empty */ }
    public static class ManageAccountsSettingsActivity extends SettingsDevice { /* empty */ }
    public static class PowerUsageSummaryActivity extends SettingsDevice { /* empty */ }
    public static class AccountSyncSettingsActivity extends SettingsDevice { /* empty */ }
    public static class AccountSyncSettingsInAddAccountActivity extends SettingsDevice { /* empty */ }
    public static class CryptKeeperSettingsActivity extends SettingsDevice { /* empty */ }
    public static class DeviceAdminSettingsActivity extends SettingsDevice { /* empty */ }
    public static class DataUsageSummaryActivity extends SettingsDevice { /* empty */ }
    public static class AdvancedWifiSettingsActivity extends SettingsDevice { /* empty */ }
    public static class TextToSpeechSettingsActivity extends SettingsDevice { /* empty */ }
    public static class AndroidBeamSettingsActivity extends SettingsDevice { /* empty */ }
    public static class WifiDisplaySettingsActivity extends SettingsDevice { /* empty */ }
    public static class AnonymousStatsActivity extends SettingsDevice { /* empty */ }
    public static class ApnSettingsActivity extends SettingsDevice { /* empty */ }
    public static class ApnEditorActivity extends SettingsDevice { /* empty */ }
    public static class ProfilesSettingsActivity extends SettingsDevice { /* empty */ }
    public static class QuietHoursSettingsActivity extends SettingsDevice { /* empty */ }
    public static class DreamSettingsActivity extends SettingsDevice { /* empty */ }
    public static class SystemSettingsActivity extends SettingsDevice { /* empty */ }
    public static class NotificationStationActivity extends SettingsDevice { /* empty */ }
    public static class UserSettingsActivity extends SettingsDevice { /* empty */ }
    public static class NotificationAccessSettingsActivity extends SettingsDevice { /* empty */ }
    public static class BlacklistSettingsActivity extends SettingsDevice { /* empty */ }
}
