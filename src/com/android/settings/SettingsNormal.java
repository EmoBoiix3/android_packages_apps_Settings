 ...
 */
public class SettingsNormal extends PreferenceActivity
    ...
    public boolean shouldUpRecreateTask(Intent targetIntent) {
        return super.shouldUpRecreateTask(new Intent(this, SettingsNormal.class));
    }
     ...
     */
    public static class BluetoothSettingsActivity extends SettingsNormal { /* empty */ }
    public static class WirelessSettingsActivity extends SettingsNormal { /* empty */ }
    public static class TetherSettingsActivity extends SettingsNormal { /* empty */ }
    public static class VpnSettingsActivity extends SettingsNormal { /* empty */ }
    public static class DateTimeSettingsActivity extends SettingsNormal { /* empty */ }
    public static class StorageSettingsActivity extends SettingsNormal { /* empty */ }
    public static class WifiSettingsActivity extends SettingsNormal { /* empty */ }
    public static class WifiP2pSettingsActivity extends SettingsNormal { /* empty */ }
    public static class InputMethodAndLanguageSettingsActivity extends SettingsNormal { /* empty */ }
    public static class KeyboardLayoutPickerActivity extends SettingsNormal { /* empty */ }
    public static class InputMethodAndSubtypeEnablerActivity extends SettingsNormal { /* empty */ }
    public static class SpellCheckersSettingsActivity extends SettingsNormal { /* empty */ }
    public static class LocalePickerActivity extends SettingsNormal { /* empty */ }
    public static class UserDictionarySettingsActivity extends SettingsNormal { /* empty */ }
    public static class SoundSettingsActivity extends SettingsNormal { /* empty */ }
    public static class DisplaySettingsActivity extends SettingsNormal { /* empty */ }
    public static class DeviceInfoSettingsActivity extends SettingsNormal { /* empty */ }
    public static class ApplicationSettingsActivity extends SettingsNormal { /* empty */ }
    public static class ManageApplicationsActivity extends SettingsNormal { /* empty */ }
    public static class AppOpsSummaryActivity extends SettingsNormal { /* empty */ }
    public static class StorageUseActivity extends SettingsNormal { /* empty */ }
    public static class DevelopmentSettingsActivity extends SettingsNormal { /* empty */ }
    public static class AccessibilitySettingsActivity extends SettingsNormal { /* empty */ }
    public static class SecuritySettingsActivity extends SettingsNormal { /* empty */ }
    public static class LocationSettingsActivity extends SettingsNormal { /* empty */ }
    public static class PrivacySettingsActivity extends SettingsNormal { /* empty */ }
    public static class RunningServicesActivity extends SettingsNormal { /* empty */ }
    public static class ManageAccountsSettingsActivity extends SettingsNormal { /* empty */ }
    public static class PowerUsageSummaryActivity extends SettingsNormal { /* empty */ }
    public static class AccountSyncSettingsActivity extends SettingsNormal { /* empty */ }
    public static class AccountSyncSettingsInAddAccountActivity extends SettingsNormal { /* empty */ }
    public static class CryptKeeperSettingsActivity extends SettingsNormal { /* empty */ }
    public static class DeviceAdminSettingsActivity extends SettingsNormal { /* empty */ }
    public static class DataUsageSummaryActivity extends SettingsNormal { /* empty */ }
    public static class AdvancedWifiSettingsActivity extends SettingsNormal { /* empty */ }
    public static class TextToSpeechSettingsActivity extends SettingsNormal { /* empty */ }
    public static class AndroidBeamSettingsActivity extends SettingsNormal { /* empty */ }
    public static class WifiDisplaySettingsActivity extends SettingsNormal { /* empty */ }
    public static class AnonymousStatsActivity extends SettingsNormal { /* empty */ }
    public static class ApnSettingsActivity extends SettingsNormal { /* empty */ }
    public static class ApnEditorActivity extends SettingsNormal { /* empty */ }
    public static class ProfilesSettingsActivity extends SettingsNormal { /* empty */ }
    public static class QuietHoursSettingsActivity extends SettingsNormal { /* empty */ }
    public static class DreamSettingsActivity extends SettingsNormal { /* empty */ }
    public static class SystemSettingsActivity extends SettingsNormal { /* empty */ }
    public static class NotificationStationActivity extends SettingsNormal { /* empty */ }
    public static class UserSettingsActivity extends SettingsNormal { /* empty */ }
    public static class NotificationAccessSettingsActivity extends SettingsNormal { /* empty */ }
    public static class BlacklistSettingsActivity extends SettingsNormal { /* empty */ }
}
